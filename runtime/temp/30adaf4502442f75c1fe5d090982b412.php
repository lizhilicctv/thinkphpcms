<?php /*a:3:{s:86:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\auth_group\admin_role.html";i:1572408326;s:77:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_meta.html";i:1572408326;s:79:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_footer.html";i:1572408326;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="catesort()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 角色排序</a> <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','<?php echo url('AuthGroup/add'); ?>','900')"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a> </span> <span class="r">共有数据：<strong><?php echo htmlentities($count1); ?></strong> 条</span> </div>
			<div class="mt-10">
				...
				<tbody>
					...
					<tr class="text-c">
						...
						<td class="td-manage">
							...
							<a title="编辑" href="javascript:;" onclick="admin_role_edit('管理员编辑','<?php echo url('AuthGroup/edit',['id'=>$data['id']]); ?>','1','1000')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<?php if($data['id'] != 1): ?>
							<a title="删除" href="javascript:;" onclick="admin_role_del(this,<?php echo htmlentities($data['id']); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
							<?php endif; ?>
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		function(result){
	        if(result===0){
	        	...
	        	$(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_start(this,<?php echo htmlentities($data['id']); ?>)" href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
	...
	layer.confirm('确认要启用吗？',function(index){
		...
		function(result){
	        if(result===0){
	        	...
	        	$(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_stop(this,<?php echo htmlentities($data['id']); ?>)" href="javascript:;" title="停用" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');
