<?php /*a:1:{s:76:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\login\login.html";i:1572408326;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal" action="" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" name="coder" style="width:180px;">
...
<div class="footer">本后台系统由<a href="http://www.biaotian.net/" target="_blank" title="河北灵鹿科技" style="color: white;">李志立</a>提供技术支持</div>
