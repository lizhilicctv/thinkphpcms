<?php /*a:3:{s:74:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\pilot\litedit.html";i:1589188419;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<div class="tabCon">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-9 col-sm-9"> <span class="select-box">
								<select name="pn_id" class="select">
									...
									<option <?php if($vo['id']==$data['pn_id']): ?> selected="selected" <?php endif; ?> value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></option>
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-9 col-sm-9"> <span class="select-box">
								<select name="fid" id="cate" class="select">
									...
									<option <?php if($vo['id']==$data['fid']): ?> selected="selected" <?php endif; ?> value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</span> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-9 col-sm-9">
							<input type="text" class="input-text" value="<?php echo htmlentities($data['name']); ?>" placeholder="导航名称" name="name">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span> 图标：</label>
						<div class="formControls col-xs-9 col-sm-9">
							<input type="hidden" name="icon" id="icon" value="<?php echo htmlentities($data['icon']); ?>" />
							  ...
							  <i class="icon Hui-iconfont lizhili-icon"><?php echo (isset($data['icon']) && ($data['icon'] !== '')?$data['icon']:'没有图标'); ?></i>
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-3 col-sm-2"><span class="c-red">*</span> 导航地址：</label>
						<div class="formControls col-xs-9 col-sm-9">
							<input type="text" class="input-text" value="<?php echo htmlentities((isset($data['url']) && ($data['url'] !== '')?$data['url']:'没有地址')); ?>" placeholder="导航地址" name="url">
						</div>
					</div>
					<div class="row cl">
