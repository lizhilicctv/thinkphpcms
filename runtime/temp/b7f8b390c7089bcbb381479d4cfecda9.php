<?php /*a:3:{s:77:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\system\index.html";i:1573096467;s:77:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_meta.html";i:1572408326;s:79:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_footer.html";i:1572408326;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
				...
				<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['type'] == '1'){ ?>
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<input type="text" id="website-title" placeholder="" name="<?php echo htmlentities($vo['enname']); ?>" value="<?php echo htmlentities($vo['value']); ?>" class="input-text">
							</div>
						</div>
					<?php } if($vo['type'] == '2'){ ?>
					<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								...
								?>   	
									<div class="radio-box" style="margin-top: 3px;padding-left: 0;">
									    ...
									    <label for="radio-1"><?php echo $v ?></label>
									</div>
								<?php	}	?>
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							...
							<input type="file" class="input-file required" onchange='onpic(this)' name="img[]" class="img"  accept='image/*' style="font-size: 20px;left:0;" />
							<span class="sp"></span>
							<?php if($vo['type'] == 4){ ?>
