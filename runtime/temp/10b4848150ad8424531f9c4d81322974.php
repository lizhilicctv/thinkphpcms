<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\login\log.html";i:1585894774;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="page-container">
		<div class="text-c">
			<form action="" method="get">
				日期范围：
				<input type="text" value="<?php echo htmlentities((isset($key['start']) && ($key['start'] !== '')?$key['start']:'')); ?>" onfocus="WdatePicker({maxDate:'#F{ $dp.$D(\'logmax\')||\'%y-%M-%d\'}'})" name="start" id="logmin" class="input-text Wdate" style="width:120px;">
				——
				<input type="text" value="<?php echo htmlentities((isset($key['end']) && ($key['end'] !== '')?$key['end']:'')); ?>" onfocus="WdatePicker({minDate:'#F{ $dp.$D(\'logmin\')}',maxDate:'%y-%M-%d'})" name="end" id="logmax" class="input-text Wdate" style="width:120px;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td><?php echo htmlentities(tonow($vo['create_time'])); ?></td>
					<td><a title="删除" href="javascript:;" onclick="article_del(this,<?php echo htmlentities($vo['id']); ?>)" class="ml-5" style="text-decoration:none"><i
