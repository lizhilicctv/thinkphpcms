<?php /*a:3:{s:80:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\advertisement\index.html";i:1585895308;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广告管理 <a class="btn btn-success radius r"
	...
	<div class="pd-20 text-c">
		<div class="text-c">
			<form action="" method="get">
				<input type="text" name="key" value="<?php echo htmlentities($key); ?>" placeholder="关键字或者广告名称" style="width:250px" class="input-text">
				<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
			</form>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" onclick="system_category_add('添加广告','<?php echo url('advertisement/add'); ?>',1000,600)"
				 href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加广告</a></span> <span class="r">共有数据：<strong><?php echo htmlentities($count1); ?></strong>
				条</span> </div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				...
				<tbody>
					<?php if(is_array($advertisement) || $advertisement instanceof \think\Collection || $advertisement instanceof \think\Paginator): $i = 0; $__LIST__ = $advertisement;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						<td><?php echo htmlentities($user['id']); ?></td>
						<td><?php echo htmlentities($user['key']); ?></td>
						...
						<td><?php echo htmlentities((isset($user['title']) && ($user['title'] !== '')?$user['title']:'尚未填写')); ?></td>
						<td>
						...
						<td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('广告编辑','<?php echo url('advertisement/edit',['id'=>$user['id']]); ?>',1000,600)"
	...
	<script type="text/javascript">
		...
		function system_category_del(obj, id) {
			layer.confirm('确认要删除吗？', function(index) {
				$.post(
					"<?php echo url('advertisement/ajax'); ?>", {
						id: id,
						type: 'advertisement_del',
					},
					function(result) {
						if (result === 0) {
							layer.msg('删除失败!', {
