<?php /*a:3:{s:76:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\admin\index.html";i:1572408326;s:77:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_meta.html";i:1572408326;s:79:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_footer.html";i:1572408326;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="data_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','<?php echo url('admin/add'); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong><?php echo htmlentities($count1); ?></strong> 条</span> </div>
					...
					<tr class="text-c">
						...
						<td class="td-manage">
							<?php if($vo['id'] != 1): if($vo['isopen'] == 1): ?> 
								...
								<?php endif; ?>
							<?php endif; ?>
							<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','<?php echo url('admin/edit',['id'=>$vo['id']]); ?>','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
							<?php if($vo['id'] != 1): ?>
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		function(result){
	        if(result===0){
	        	...
	        	$(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_start(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
	...
	layer.confirm('确认要启用吗？',function(index){
		...
		function(result){
	        if(result===0){
	        	...
	        	$(obj).parents("tr").find(".td-manage").prepend('<a onClick="admin_stop(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="停用" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>');
