<?php /*a:3:{s:76:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\system\list.html";i:1573095749;s:77:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_meta.html";i:1572408326;s:79:"D:\phpstudy_pro\WWW\thinkphpcms.com\application\manage\view\common\_footer.html";i:1572408326;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<title>系统配置列表 - 系统配置管理 - H-ui.admin v3.0</title>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加系统配置" _href="article-add.html" onclick="article_add('添加系统配置','<?php echo url('system/add'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加系统配置</a>
				</span>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('友情链接编辑','<?php echo url('system/edit',['id'=>$user['id']]); ?>','1','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
								<?php if($user['st']!= '1'){ ?>
								<a title="删除" href="javascript:;" onclick="article_del(this,<?php echo htmlentities($user['id']); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
								<?php } ?>
							</td>
						</tr>
