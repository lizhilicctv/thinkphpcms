<?php /*a:3:{s:74:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\system\config.html";i:1585880499;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
			...
			<form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-article-add">
				...
				<div style="border: 1px solid #D0D0D0;padding-bottom: 20px;margin: 0 20px 20px 20px;border-radius: 20px;background: #fefefe">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9" style="color: #31B0D5;text-align: left;line-height: 50px;padding-top: 10px;">远程图片使用静态加速或者禁止转载，不能添加水印</div>
					</div>
					<div class="row cl">
				...
				<div style="border: 1px solid #D0D0D0;padding-bottom: 20px;margin: 0 20px  20px 20px;border-radius: 20px;background: #fefefe">
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9" style="color: #31B0D5;text-align: left;line-height: 50px;padding-top: 10px;">开启后按照设置走(长宽比例不变，这里设定的是最大宽高)(默认宽高为300*300)。如果不开启，缩略图大小不变！<b>远程图片使用静态加速或者禁止转载，设置大小不生效</b></div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9 ">
							缩略图宽: <input type="number" class="input-text" value="<?php echo htmlentities($data['t_w']); ?>" placeholder="请填写缩略图宽" name="t_w" style="width: 30%;">
							px
							<span style="padding: 0 10px;"> </span>
							缩略图高: <input type="number" class="input-text" value="<?php echo htmlentities($data['t_h']); ?>" placeholder="请填写缩略图高" name="t_h" style="width: 30%;">
							px
						</div>
					</div>
