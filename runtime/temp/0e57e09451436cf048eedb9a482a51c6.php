<?php /*a:3:{s:70:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\pilot\nav.html";i:1589178955;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 顶部导航管理 <a class="btn btn-success radius r"
	...
	<div class="pd-20 text-c">
		<div class="cl pd-5 bg-1 bk-gray"> <span class="l"><a href="javascript:;" onclick="catesort()" class="btn btn-danger radius"><i
					 class="Hui-iconfont">&#xe6e2;</i> 更新排序</a> <a class="btn btn-primary radius" onclick="system_category_add('添加顶部导航','<?php echo url('pilot/navadd'); ?>',700,400)"
				 href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加顶部导航</a></span> <span class="r">共有数据：<strong><?php echo htmlentities($count1); ?></strong>
				条</span> </div>
		<div class="mt-20">
			...
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				...
				<tbody>
					<?php if(is_array($pilot_nav) || $pilot_nav instanceof \think\Collection || $pilot_nav instanceof \think\Paginator): $i = 0; $__LIST__ = $pilot_nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						...
						<td><?php echo isset($user['name']) ? htmlentities($user['name']) : '尚未填写'; ?></td>
						<td>
						...
						<td class="f-14">
							...
							<?php endif; ?>
							<a title="编辑" href="javascript:;" onclick="system_category_edit('幻灯片编辑','<?php echo url('pilot/navedit',['id'=>$user['id']]); ?>',700,400)"
