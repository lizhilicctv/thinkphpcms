<?php /*a:3:{s:71:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\cate\index.html";i:1591343681;s:73:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_meta.html";i:1585880499;s:75:"D:\phpstudy_pro\WWW\thinkphpcms\application\manage\view\common\_footer.html";i:1585880499;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td class="td-status">
								<?php switch($vo['isopen']): case "1": ?><span class="label label-success radius">展示</span><?php break; case "0": ?><span class="label label-default radius">隐藏</span><?php break; ?>
								<?php endswitch; ?>
							</td>
							<td class="f-14">
								<?php if($vo['isopen'] == 1): ?>
								<a style="text-decoration:none" onClick="cate_stop(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>
								<?php else: ?>
								<a onClick="cate_start(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>
								<?php endif; ?>
